...
typeset -A MY_MACROS
MY_MACROS=(
  "git-diff-ignores"      "':!src/domain/*_test.go' ':!*_gen.go' ':!*.generated.go' ':!.gqlgenc.yml'"
  "git-diff-ignores-test" "':!src/domain/*_test.go' ':!*_gen.go' ':!*.generated.go' ':!.gqlgenc.yml' ':!*_test.go'"
)
